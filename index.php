...
<html lang="en">
    ...
    <div id="pagepiling" class="pagepiling">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="text-left">
                                    ...
                                    <p class="text-muted">Desarrollador Web Senior con más de 10 años de experiencia especializada en el desarrollo back-end. Capacitado profesionalmente para trabajar bajo presión acorde con las metas y objetivos definidos por el usuario, y enfocado en alcanzar la entrega a tiempo, considerando todas las etapas del ciclo de desarrollo para proyectos web dinámicos.
        ...
        <!--   Services Start   -->
       <!-- <section id="services" class="section pp-scrollable services bg-dark" data-navigation-color="#fff" data-navigation-tooltip="SERVICIOS" style="display :none;">
            <div class="display-table">
                <div class="display-content">
                    <div class="container">
                        <div class="row">
                            <div class="title-small">
                                <p class="text-dark">Mis Servicios</p>
                            </div>
                            <div class="col-lg-12">
                                <div class="text-left">
                                    <h2 class="text-dark mb-3">Mis <span class="base-color">Servicios</span></h2>
                                    <p class="text-muted">Actividades que realizo con pasión</p>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 text-left">
                                <div class="services-item">
                                    ...
                                    <div class="services-content">
                                        <h5 class="mb-3">Diseño Gráfico</h5>
                                        <p class="text-muted mb-0">En un contexto profesional sucede a menudo que clientes privados solicitan la realización de una publicación.</p>
                                    </div>
                                </div>
                            </div>
